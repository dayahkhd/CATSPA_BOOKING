  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" align="center"> <b>Hello, <?php echo  htmlentities(strtoupper($cstname));?>!</b></h3>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
                  ...
                  <table class="table table-striped table-bordered table-hover" id="dataTable-2">
                    ...
                    <tbody>
                      <?php
                        ...
                        $query2 = "SELECT * FROM appointment WHERE id_cust='$cstid'"; //call by id 
                        ...
                        if($data < 1){
                              ?>
                              <tr><td colspan="5" align="center"> You have not make any appointment yet. </td></tr>
                              <?php
                        }
                        else{
                          $sn =1;
                      ...
                      <tr class="odd gradeX">
                        ...
                        <td align="center">
                          <p>
                            <a href="checkappt.php?id=<?php echo $apid;?>">
                        ...
                        <td align="center">
                          <p>
                            <a href="delappt.php?id=<?php echo $apid;?>">
        ...
        ?>
          ...
          <!-- <button onclick="window.location='form.php';" class="btn btn-primary">New Appointment</button> -->
