    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          ...
          <li><a href="services_cust.php">Grooming Services</a></li>
        </ol>
    ...
    <section class="inner-page">
      <div class="container">
        ...
        <?php
          ...
          $query = "SELECT id, pname, pdesc, pprice FROM package";
        ...
        <div class="card" style="width: 80rem;">
          <div class="card-body">
            <a class="card-title" href="form.php?id=<?php echo $pid; ?>" style="font-size: 30px;">
